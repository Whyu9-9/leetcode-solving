...
The 'start' timestamp will always be before the 'end' timestamp for every (machine_id, process_id) pair.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
